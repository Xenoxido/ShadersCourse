...
// Move a rect with mouse position (fragment shader)
// void main (void)
// {
//   float radius = 0.5;
//   float angle = u_time;
//   vec2 mouseClip = u_mouse - (u_resolution*0.5); // transform mouse coordinates to -u_resolution/2 - u_resolution/2
//   mouseClip.y = -mouseClip.y;
//   vec2 center = mouseClip / u_resolution;
//   float inRect = rect(vPosition.xy, vec2(0.5), center*2.0);
